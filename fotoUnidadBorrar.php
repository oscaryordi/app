...
$sql_AC = $id_foto."-".$id_prov."-BORRAR" ; // ARRAY ORIGINAL

if($id_foto != 0) // SI NO ESTA SUSPENDIDO, PROCEDE
{
	// INICIO SUSPENDER
	$sql_SC 	=  "UPDATE fotoUnidad SET borrar = '1' WHERE id_foto = '$id_foto' LIMIT 1";
	...
	if($sql_SC_R)
		{
			header("Location: fotoUnidadGaleria.php?id_unidad=".$id_unidad."");
		}
}else{
	header("Location: fotoUnidadGaleria.php?id_unidad=".$id_unidad."");}