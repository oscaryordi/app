...
echo "<!-- CANDADO PRIVILEGIO --><meta charset='utf-8'>";
...
$sql_ccump = 'SELECT 
			id_polcum, id_cliente, id_contrato, poliza, 
...
$arrayviejo =  "id_contrato = ".$id_contrato.",  id_cliente = ".$id_cliente.",  id_polcum = ".$id_polcum
				.",  poliza = ".$poliza
...
if (isset($_GET['actualizar']) 
	...
	{ 
		// INICIO Formatear y limpiar datos
			...
			$id_polcum	 = 	mysqli_real_escape_string($dbd2, $_GET['id_polcum']);
		...
		// INICIO Update BD
		$sql_polcum_up = "	UPDATE  `jetvantlc`.`clcCmpl`  
							SET 
							poliza 		=  '$poliza',  
							...
							AND id_polcum = '$id_polcum' 
							LIMIT 1 ";
		$res_polcum_up = mysqli_query($dbd2, $sql_polcum_up);
		// TERMINA Update DB
		...
		else
		{
			...
			if($res_polcum_up)
			{ 
				$sql_up 	= mysqli_real_escape_string($dbd2, $sql_polcum_up);
				...
				echo "<br><h2>ACTUALIZACION DE POLIZA DE CUMPLIMIENTO EXITOSA</h2><br>";
			}
			$actualizado = 'si';
		}
	}
...
echo "<h2>EDITAR POLIZA DE CUMPLIMIENTO</h2>";
?>
...
<form action="<?php echo $_SERVER['PHP_SELF'];?>" method="GET">
	<table>
		<tr>
			<th colspan=2>FORMULARIO EDITAR POLIZA DE CUMPLIMIENTO</th>
		</tr>
		...
		<tr>
			...
			<td>
				...
				<input type="hidden" name="id_polcum" value="<?php echo $id_polcum; ?>">  
			</td>
		</tr>
		...
		<tr>
			<td colspan=2 align=center><INPUT id="gobutton" TYPE="submit" NAME="actualizar" VALUE="Editar POLIZA DE CUMPLIMIENTO"></td>
		</tr>
