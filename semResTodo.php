...
//$cuenta_gps = " SELECT id_venta FROM sem WHERE '$fechainicio' <= fechaFact AND  fechaFact <= '$fechafinal'  ";
$cuenta_gps 		= " SELECT id_venta FROM sem ";
...
?>
<style>
	#seminuevosTabla tr:hover {background-color: #ddd;}
</style>
<?php
...
// SI CONSULTA GERENTE
	$sql_sem = 'SELECT * '
        . ' FROM sem '
 //       . "  WHERE '$fechainicio' <= fechaFact AND  fechaFact <= '$fechafinal' "
        . ' ORDER BY '
 //       . ' vendedor ASC,'
        . '  id_venta DESC '
...
// INICIO poner renglon resultados
	...
	if($fechaFact == '0000-00-00 00:00:00'){$fechaFact='0000-00-00';}
		else
		{
	...
	echo "<td><a href='semVentaEdit.php?id_venta=$id_venta&pagina=$pagina'  
