...
$cuenta_gps;
$cuenta_gps 		= " SELECT id_mttoSol FROM mttoSol  WHERE cancelado = 0  AND autorizadoS != 0  AND autorizadoS != 1 AND fechaEj >  '2017-02-06' ";	
...
// echo $cuenta."<br>";
// echo $paginas."<br>";
echo "<h2>RESUMEN DE MANTENIMIENTO EN <span style='color: RED;' >CORRECCION</span></h2>";
...
// SI CONSULTA SUPERVISOR
	$sql_mttoSol = 'SELECT * '
        . ' FROM mttoSol '
        . "  WHERE cancelado = 0  AND autorizadoS != 0  AND autorizadoS != 1 AND fechaEj >  '2017-02-06' "
        . ' ORDER BY '
        . ' id_mttoSol '
        . ' ASC '
