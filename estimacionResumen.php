...
##### estimado archivos
	...
	conveniosxid($id_contrato);


	echo "<tr><th>MINIMO CONTRATO:</th><td style='color:green;'> $".@number_format($min, 2)."</td></tr>";
	echo "<tr><th>MAXIMO CONTRATO:</th><td style='color:green;'> $".@number_format($max, 2)."</td></tr>";
	echo "<tr><th>MINIMO CONVENIOS:</th><td style='color:green;'> $".@number_format($minSC, 2)."</td></tr>";
	echo "<tr><th>MAXIMO CONVENIOS:</th><td style='color:green;'> $".@number_format($maxSC, 2)."</td></tr>";

$minT = $min + $minSC;
$maxT = $max + $maxSC;

	echo "<tr><th>MINIMO TOTAL:</th><td style='color:green;'> $".@number_format($minT, 2)."</td></tr>";
	echo "<tr><th>MAXIMO TOTAL:</th><td style='color:green;'> $".@number_format($maxT, 2)."</td></tr>";
