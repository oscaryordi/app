...
//		&& $_POST['facturaT']!='' 
	)
	{
			...
			@$id_clienteD	=mysqli_real_escape_string($dbd2, $_POST['id_clienteD']);
			@$id_contratoD 	=mysqli_real_escape_string($dbd2, $_POST['id_contratoD']);

			@$aliasEmergente =strtoupper(mysqli_real_escape_string($dbd2, $_POST['aliasEmergente']));

			$id_prov	=mysqli_real_escape_string($dbd2, $_POST['id_prov']);
			$conductor	=mysqli_real_escape_string($dbd2, $_POST['conductor']);
			...
			$domicilioO =strtoupper(mysqli_real_escape_string($dbd2, $_POST['domicilioO'])) ;
			...
			$domicilioD =strtoupper(mysqli_real_escape_string($dbd2, $_POST['domicilioD'])) ;
