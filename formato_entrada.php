...
// PARA UBICACION DESTINO
switch($_SESSION["oficina"]){
	case 1:
		$proyecto_destino	= 'JETVAN TACUBA';
		$ubicacion_destino	= 'CALZADA MEXICO - TACUBA';
		$prefijoFolio 		= 'MX';
		break;
	case 2:
		$proyecto_destino	= 'JETVAN TLCG';
		$ubicacion_destino	= 'OFICINA TULANCINGO';
		$prefijoFolio 		= 'TG';
		break;
	case 3:
		$proyecto_destino	= 'JETVAN PZRC';
		$ubicacion_destino	= 'OFICINA POZA RICA';
		$prefijoFolio 		= 'PR';
		break;
	case 4:
		$proyecto_destino	= 'JETVAN CNVC';
		$ubicacion_destino	= 'OFICINA CUERNAVACA';
		$prefijoFolio 		= 'CV';
		break;
	case 5:
		$proyecto_destino	= 'JETVAN MARN';
		$ubicacion_destino	= 'OFICINA MARINA';
		$prefijoFolio 		= 'MA';
		break;
	case 6:
		$proyecto_destino	= 'JETVAN JCHTN';
		$ubicacion_destino	= 'OFICINA JUCHITAN';
		$prefijoFolio 		= 'JT';
		break;
	case 7:
		$proyecto_destino	= 'JETVAN RIVIERA';
		$ubicacion_destino	= 'OFICINA RIVIERA';
		$prefijoFolio 		= 'RV';
		break;
	case 8:
		$proyecto_destino	= 'JETVAN TOLUCA';
		$ubicacion_destino	= 'OFICINA TOLUCA';
		$prefijoFolio 		= 'TL';
		break;
	case 9:
		$proyecto_destino	= 'JETVAN GUANAJUATO';
		$ubicacion_destino	= 'OFICINA GUANAJUATO';
		$prefijoFolio 		= 'GT';
		break;
	case 10:
		$proyecto_destino	= 'JETVAN MONTERREY';
		$ubicacion_destino	= 'OFICINA MONTERREY';
		$prefijoFolio 		= 'MT';
		break;

	case 11:
		$proyecto_destino	= 'JETVAN QUERETARO';
		$ubicacion_destino	= 'OFICINA QUERETARO';
		$prefijoFolio 		= 'QR';
		break;
...
// PREPARAR CODIGO PARA INSERCION	
 $numero_inventario = $prefijoFolio;
// TEXTO TIEMPO Y DIFERENTES DE 1 Y 0
 ...
 // VARIABLES PARA ENTRADA DE UNIDADES A JETVAN
...
// ESPECIAL CAMPO PARA AUTO SUSTITUTO
//id_sustE
...
if($id_sustE !== ''){
		...
		$sql_sustituto_devuelto = "	UPDATE sustituto 
									SET 
									id_formatoF 	= '$id_formato_actual', 
									fechaF 			= '$fecharecepcion', 
									horaF 			= '$hora_entrada' 
									WHERE id_sust = '$id_sustE' LIMIT 1 ";
		$sql_sust_dev_res 		= mysqli_query($dbd2, $sql_sustituto_devuelto );
}
...
<?php if ($insertado == ''){  // APERTURA FORMATO INVENTAIRO   
...
$sql_tiene_folio_sust = "SELECT * FROM sustituto WHERE serieSustituto = '$SerieS' AND fechaI IS NOT NULL AND fechaF IS NULL AND status = '1' ORDER BY id_sust DESC LIMIT 1 ";
...
while($row_tiene_folio = mysqli_fetch_assoc($sql_tiene_folio_sust_res)){
	...
	echo "<h2 style='color:red;'> Unidad fue entregada como sustituto con folio $id_sust_pendiente FAVOR DE VERIFICAR </h2><br>";
}
...
<tr><td class = "folio" id="folio"><INPUT TYPE="text" NAME="numero_inventario" placeholder="PROCESANDO" required ></td></tr>
</table>
</td>
</tr>
</table>
...
<th> FECHA DE RECEPCION VEHICULO </th> <td><INPUT TYPE="text" NAME=" fecharecepcion" placeholder=" fecha "   value= "<?php echo date("Y-m-d");?>"></td>
...
<td>SERIE</td> <td colspan=3><INPUT TYPE="text" NAME="serie" placeholder="serie"   value="<?php echo @$Serie;?>" >
<INPUT TYPE="hidden" NAME="id_unidad" placeholder="id_unidad"   value="<?php echo @$id_unidad?>" >
</td>
</tr>
</table>
<br>
...
<?php // SCRIPT PARA QUE SE ACTUALICE LA HORA POR SEGUNDO?>
...
<!-- <td colspan=2 ><INPUT TYPE="text" NAME="hora_entrada" id='hora_entrada' ></td> -->
 <td colspan=2 ><INPUT TYPE="time" NAME="hora_entrada" value="<?php  echo date("H:i:s"); // i es para minutos?>" ></td> 
...
<td><INPUT TYPE="text" NAME="placasustituido" placeholder="placa unidad sustituida"   disabled > PLACAS base</td>
</tr>
...
<INPUT TYPE="number" NAME="id_sustS" placeholder="folio solicitud sustituto"  value="<?php echo ''; ?>"  disabled > FOLIO sustituto S
...
<tr>
<td>FUE SUSTITUTO</td>
<td><input type="radio" name="razonentrada" value="Fue Sustituto"  >Si</td>
<td>
<!--#################### FOLIO SUSTITUTO ENTRADA ####################-->	
<input type="number" name="id_sustE" placeholder="folio solicitud sustituto" value="<?php echo $id_sust_pendiente;?>" > FOLIO sustituto E
...
<td>PROYECTO DESTINO</td> <td>
<INPUT TYPE="text" NAME="proyecto_destino" placeholder="proyecto destino"   value="<?php echo $proyecto_destino;?>" class='obs' disabled >
<INPUT TYPE="text" NAME="proyecto_destino" placeholder="proyecto destino"   value="<?php echo $proyecto_destino;?>" class='obs' hidden >
</td> <!-- SALIDA -->
</tr>
<tr>
<td>UBICACIÓN ORIGEN</td> <td><INPUT TYPE="text" NAME="ubicacion_origen" placeholder="ubicación origen"   class='obs'></td>
<td>UBICACIÓN DESTINO</td> <td>
<INPUT TYPE="text" NAME="ubicacion_destino" placeholder="ubicación destino"   value="<?php echo $ubicacion_destino;?>" class='obs' disabled >
<INPUT TYPE="text" NAME="ubicacion_destino" placeholder="ubicación destino"   value="<?php echo $ubicacion_destino;?>" class='obs' hidden >
</td> <!-- SALIDA -->
</tr>
<tr>
