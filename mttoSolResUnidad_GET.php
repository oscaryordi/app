...
header("content-disposition: attachment;filename=ResumenMttoUnidad.xls");
session_start();
...
echo "<b>RESUMEN DE MANTENIMIENTO DE UNIDAD VEHICULAR</b><br/>";

//<a href='u3index.php?id_unidad=$id_unidad&pagina=$pagina' title='Consultar UNIDAD'></a>
	datosxid($id_unidad);
	echo "<td>{$Economico} ::: {$Placas} ::: {$Serie} ::: {$Vehiculo}</td><br/><br/>";
