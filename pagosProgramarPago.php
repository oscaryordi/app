...
if($_SESSION["mttoSolPag"] > 0){
	...
	$capturo	= $_SESSION["id_usuario"];
	 ...
	 // INICIO "CANCELAR"
	$sql_progPago = " UPDATE mttoSol SET programadoPago = 1, fechaPg = '$fechaPg' WHERE id_mttoSol = '$id_mttoSol'  " ;
	...
	{
		$sql_CC = "INSERT INTO controlcambios (id_cambios, capturo, updatequery, arrayviejo) VALUES (NULL, '$capturo', 'pago programado', '$id_mttoSol') ";
		...
		if($sql_CC_R)
			{
				if($pagina>0)
				{
					header("Location: pagosResTodo.php?pagina=$pagina");
				}
				else
				{
