...
$sql_mttoSol = "SELECT * FROM mttoSol WHERE capturo like '%%' AND ('2017-01-01' <= `fechaEj` AND `fechaEj` <= '2018-01-01') AND ( AutorizadoS = 2 OR AutorizadoS = 3 OR AutorizadoS = 4 ) ORDER BY id_mttoSol";
/*
if($_SESSION["mttoSol"] == 2){
