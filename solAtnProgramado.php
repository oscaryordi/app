...
echo "<br>";
	...
	$horaPg 		= $row['horaPg'];
	$descPg 		= $row['descPg'];
	$capturoPg 		= $row['capturoPg']; // SEGUIMIENTO
...
if(isset($_POST['SolicitarXXXy']))
			...
			{	
				...
				if($noProcede == 0 && $sql_SAtnPGR )
				{
					...
					//$mail->AddEmbeddedImage('img/logoMailCh.jpg','logo'); data-embeded='auto' 
						...
						$contenido = '<html><body>'; 
						$contenido .= "<h2 style='color:green;'><img src='cid:$cid'  data-embeded='auto' > PROGRAMCION Jet Van WEB</h2>";
						...
						$contenido .= "<tr><td>TELEFONO:</td><td>$telefonoCP</td></tr>";
 ...
 if($subido!='ok') {// INICIA MOSTRAR FORMULARIO
	...
	$capturoPg 	;
?>
<fieldset><legend><b>PROGRAMADO</b></legend>
<form action="solAtnMttoSol.php" method="GET"  enctype="multipart/form-data" >
	<h2>DESCRIPCION DE SERVICIO PROGRAMADO</h2>
<table>
		...
		<input type="hidden" name="sa3" 	value="<?php echo $sa3;?>" >
		<input type="hidden" name="sa4" 	value="<?php echo $sa4;?>" >
	<tr >
		<th>NOMBRE DE TALLER O AGENCIA</th>
		<td>
			<?php
						proveedorxid($id_prov);
						echo "$PrazonSocial <br> $PaliasProv ";
			?>
		</td>
	</tr>
	...
	<tr>
		<td colspan=2 style="text-align:center;" >
			...
			<input type='submit' name='GenerarSolicitud' id="gobutton2" value='Generar Solicitud de Mantenimiento' >
		<!--
			<input id="gobutton2" type="submit" name="SolicitarXXXy" value="PROGRAMAR SERVICIO" disabled > 
		-->
		</td>
	</tr>
