...
if (isset($_GET['actualizar']) 
	...
	{ 
		...
		$sql_pcmpl = "INSERT INTO `jetvantlc`.`cleRc` 
		(id_polrc, id_cliente, id_contrato,  poliza, afianzadora, 
		fecha, sumasegurada, periodo, pagada, montofactura, 
		capturo) VALUES  
		(NULL, '$id_cliente', '$id_contrato',  '$poliza', '$afianzadora', 
		'$fecha', '$sumasegurada', '$periodo', '$pagada', '$montofactura', 
		'$capturo') ";
		...
		echo mysqli_errno($dbd2) . ": " . mysqli_error($dbd2). "\n";
			...
			echo "<br><h2>REGISTRO DE POLIZA DE RESPONSABILIDAD CIVIL EXITOSO</h2><br>";
		}
		$actualizado = 'si';
	}
...
echo "<h2>AGREGAR NUEVA POLIZA DE RESPONSABILIDAD CIVIL</h2>";
?>
...
<form action="<?php echo $_SERVER['PHP_SELF'];?>" method="GET">
	<table>
		<tr>
			<th colspan=2>FORMULARIO REGISTRAR NUEVA POLIZA DE RESPONSABILIDAD</th>
		</tr>
		...
		<tr>
			...
			<td>
				<input type="number" lang="nb" step="0.01" min="0" name="sumasegurada" value="0<?php //echo $clabe; ?>"  required >
			</td>
		</tr>
		...
		<tr>
			<td>Periodo</td>
			<td>
				<input type="text" name="periodo" value="<?php //echo $cuenta; ?>"  required >
			</td>
		</tr>
		...
		<tr>
			<td colspan=2 align=center><INPUT id="gobutton" TYPE="submit" NAME="actualizar" VALUE="Registrar POLIZA DE RESPONSABILIDAD"></td>
		</tr>
