...
if (@$flag!='ok') { // INICIO Mostrar formulario ?>
	...
	<div id="form">
		...
		<form action="<?php echo $PHP_SELF;?>" method="POST" enctype="multipart/form-data" >
			...
			name = "tipo" id=select >
				  ...
				  <option>POLIZA DE CUMPLIMIENTO</option>
				  <option>POLIZA DE CONFIDENCIALIDAD</option>
				  <option>POLIZA DE RESPONSABILIDAD CIVIL</option>
				  <option>OTRO</option>
			</select></p>
			...
			<?php if (isset ($flag) && $_POST['obs']=='') 
						{ echo 'class="error"';} 
					else {echo 'class="campo"';} ?> 
			type="text" name="obs" value="<?php echo @$_POST['obs'];?>" /></p>
...
// BOTON cliente
    echo "<p>
			...
			<INPUT TYPE='SUBMIT' id='gobutton' NAME='ENVIAR' VALUE='Volver a Cliente'>
		</FORM>
        </p>";
 // BOTON cliente
