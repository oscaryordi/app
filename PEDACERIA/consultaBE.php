...
<form action="consultaBE.php" method="post">
<table>
	<tr><td>
...
<p>	<input type="submit" name="search" value="Buscar" />
	<a href='consultaBE.php' style='text-decoration: none;'>
...
$tn2016 		= (isset($_POST['tn2017']) 			&& $_POST['tn2017'] == 1)		? 1:0 ;
$tn2015 		= (isset($_POST['tn2017']) 			&& $_POST['tn2017'] == 1)		? 1:0 ;
$tn2014 		= (isset($_POST['tn2017']) 			&& $_POST['tn2017'] == 1)		? 1:0 ;
$tn2013 		= (isset($_POST['tn2017']) 			&& $_POST['tn2017'] == 1)		? 1:0 ;
/*
