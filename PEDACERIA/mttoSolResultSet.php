...
*/		}
	...
	if($pagadoInfo == 1)
		{
			$pagadoInfoMostrar = "<a href='http://187.188.203.80:8021/pdfpagos/getfile.php?uuid=".$id_mttoSol."'  target='_blank'  ><span class='pagadoInfoM' title='VER AVISO DE PAGO' >$</span></a>";
		}
