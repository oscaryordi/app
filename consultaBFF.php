...
<h2>CONSULTA POR FOLIOS DE FACTURA DE ORIGEN</h2>

<form action="" method="post">
<table>
	<tr><td>

	<p><label>Escribe en el siguiente campo los Folios a buscar separados por comas (,) :</label></p>
...
if (isset($_POST['search'])) {
	...
	{
		global $conectar;
		$sql_idUnidad 	= "SELECT id_unidad FROM facturaunidad WHERE folioFactura = '$value' ";
		$sql_idUnidad_R = mysqli_query($dbd2, $sql_idUnidad);
		$renglon		= mysqli_fetch_assoc($sql_idUnidad_R);
		$id_unidadXXX 	= $renglon['id_unidad'];
