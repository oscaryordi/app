...
if (isset($_GET['actualizar']) 
	...
	{ 
		...
		$sql_pcmpl = "	INSERT INTO `jetvantlc`.`clcCmpl` 
...
echo "<h2>AGREGAR NUEVA POLIZA DE CUMPLIMIENTO</h2>";
?>
...
<form action="<?php echo $_SERVER['PHP_SELF'];?>" method="GET">
	<table>
		...
		<tr>
			<td colspan=2 align=center><INPUT id="gobutton" TYPE="submit" NAME="actualizar" VALUE="Registrar POLIZA DE CUMPLIMIENTO"></td>
		</tr>
