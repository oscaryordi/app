...
$cuenta_gps 		= " SELECT id_mttoSol FROM mttoSol WHERE capturo = '116' AND id_cliente = 2 AND id_contrato = 137";
}
...
// SI CONSULTA EJECUTIVO
	$sql_mttoSol = 'SELECT * '
        . ' FROM mttoSol '
        . "  WHERE capturo = '116' AND id_cliente = 2 AND id_contrato = 137 "
        . ' ORDER BY '
        . ' id_mttoSol '
        . ' DESC '
